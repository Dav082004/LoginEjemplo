...
public class Conexion {              // Declaración de la clase `Conexion`
    String bd = "login_ejem";               // Nombre de la base de datos por defecto
    ...
    public static void main(String[] args) throws SQLException {
        Conexion conexion = new Conexion("login_ejem");  // Crea una instancia de `Conexion` con la base de datos `inv`
