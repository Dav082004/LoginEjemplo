...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 230, 330, 30));
    ...
    private void btnIniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarActionPerformed
        ...
        try {
            ...
            try {
                if (rs != null) rs.close(); // Cierra el resultado si no es nulo
                if (st != null) st.close(); // Cierra la sentencia si no es nula
            } catch (SQLException ex) {
